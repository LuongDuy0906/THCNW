...
<body>
    ...
    <form action="<?php echo e(route('issues.store')); ?>" method="POST" style="margin: 50px 50px">
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="computer_id" name="computer_id" required>
                <?php $__currentLoopData = $computers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $computer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($computer->id); ?>"><?php echo e($computer->computer_name); ?></option>
        ...
        <div class="mb-3">
            ...
            <select class="form-control" id="computer_id" name="computer_id" required>
                <?php $__currentLoopData = $computers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $computer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($computer->id); ?>"><?php echo e($computer->operating_system); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
        </div>
        <div class="mb-3">
...
</body><?php /**PATH C:\xampp\htdocs\TH4_2\resources\views/issues/create.blade.php ENDPATH**/ ?>